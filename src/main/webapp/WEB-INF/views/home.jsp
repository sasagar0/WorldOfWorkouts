		...
		<div class="site-wrapper-inner">
			<div class="cover-container">
				<div class="masthead clearfix">
					<div class="inner">
						<h3 class="masthead-brand">World of Workouts</h3>
						<nav>
				...
				<div class="inner cover">
					...
					workout templates for all kinds of lifters.</i></marquee></p>
					<p class="lead">
				...
				<div class="mastfoot">
					<div class="inner">
						<p>
							All rights reserved World of Workouts (WoWo).
						</p>
					</div>
				</div>
